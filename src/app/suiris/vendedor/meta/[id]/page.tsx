  ...
  const [clientes, setClientes] = useState<ClienteVisita[]>([
    {
      ...
      endereco: "Av. Santos Dumont, 1234 - Aldeota",
      status: "visitado",
      dataVisita: "2024-10-10",
      resultado:
        "Apresentação realizada com sucesso. Cliente interessado em pacote premium.",
      proximoPasso: "Enviar proposta comercial até 15/10",
    ...
    },
    {
      ...
      email: "maria@betasolutions.com",
      endereco: "Rua Barão de Studart, 456 - Meireles",
      status: "visitado",
      dataVisita: "2024-10-11",
      resultado:
        "Cliente solicitou demonstração do produto. Objeção sobre preço.",
      proximoPasso: "Agendar demo técnica para próxima semana",
      valorNegociado: 8500,
      potencial: "medio",
    },
    {
      id: 3,
      nome: "Gamma Corporation",
      contato: "Pedro Oliveira",
      cargo: "Gerente de TI",
      telefone: "(85) 99999-1234",
      email: "pedro@gammacorp.com",
    ...
    {
      id: 5,
      nome: "Epsilon Enterprises",
      contato: "Roberto Silva",
      cargo: "Diretor Financeiro",
      telefone: "(85) 96666-4444",
      email: "roberto@epsilon.com",
      endereco: "Av. Dom Luís, 567 - Meireles",
      status: "visitado",
      dataVisita: "2024-10-12",
      resultado: "Cliente não estava presente. Remarcada para próxima semana.",
      proximoPasso: "Confirmar visita por telefone",
      valorNegociado: 0,
      potencial: "baixo",
    },
    {
      id: 6,
      nome: "Zeta Business Group",
      contato: "Julia Mendes",
      cargo: "CEO",
      telefone: "(85) 95555-3333",
      email: "julia@zetabg.com",
